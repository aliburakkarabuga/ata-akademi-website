...
export default function HomePage() {
  ...
  return (
    <>
        ...
        <div className="section-shell relative z-10 grid min-h-[calc(100vh-5rem)] items-center gap-10 py-14 lg:grid-cols-[1.08fr_0.92fr] lg:py-20">
          <div className="max-w-3xl">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <ButtonLink href="#free-trial">Ücretsiz deneme dersi al</ButtonLink>
      ...
      <section className="section-shell py-16 sm:py-20">
        <SectionHeading
          eyebrow="Bireysel Takip ve Eğitim Koçluğu"
          title="Her öğrenci, bireysel olarak takip edilen bir eğitim yolculuğunun parçası"
          description="Öğrenci, veli ve kurum arasında güçlü bir iletişim ağı kurarak akademik başarıyı en üst seviyeye taşımayı hedefliyoruz."
        />
        <div className="mt-10 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
          <article className="rounded-md bg-white p-6 shadow-sm ring-1 ring-line">
            <UserCheck className="h-8 w-8 text-gold" aria-hidden />
            <h3 className="mt-5 text-xl font-semibold text-ink">Kişiye özel koçluk</h3>
            <p className="mt-3 leading-7 text-muted">
              Her öğrencinin akademik durumu, gelişim süreci ve ihtiyaçları düzenli olarak analiz edilerek bireysel yönlendirme yapılır.
            </p>
          </article>
          <article className="rounded-md bg-white p-6 shadow-sm ring-1 ring-line">
            <MessageCircle className="h-8 w-8 text-gold" aria-hidden />
            <h3 className="mt-5 text-xl font-semibold text-ink">WhatsApp ile soru desteği</h3>
            <p className="mt-3 leading-7 text-muted">
              Öğrenciler ders dışında çözemedikleri soruları WhatsApp üzerinden öğretmenlere iletebilir ve hızlı geri dönüş alabilir.
            </p>
          </article>
          <article className="rounded-md bg-white p-6 shadow-sm ring-1 ring-line md:col-span-2 lg:col-span-1">
            <Webhook className="h-8 w-8 text-gold" aria-hidden />
            <h3 className="mt-5 text-xl font-semibold text-ink">Veliye düzenli bildirim</h3>
            <p className="mt-3 leading-7 text-muted">
              Derse katılım, işlenen konular, ödevler ve akademik gelişim; WhatsApp üzerinden düzenli olarak velilerle paylaşılır.
            </p>
          </article>
        </div>
        <div className="mt-6 rounded-md bg-navy p-6 text-white">
          <div className="grid gap-6 sm:grid-cols-3">
            {[
              "Derse katılım durumu",
              "İşlenen konular ve ödevler",
              "Akademik gelişim raporu"
            ].map((item) => (
              <div key={item} className="flex items-center gap-3">
                <CheckCircle2 className="h-5 w-5 shrink-0 text-[#e8bf6a]" aria-hidden />
                <span className="text-sm font-medium text-white/90">{item}</span>
              </div>
            ))}
          </div>
          <p className="mt-4 text-xs text-white/50">Veli bilgilendirmeleri WhatsApp üzerinden düzenli olarak iletilir.</p>
        </div>
      </section>
